<?php   
    class GDatabaseViewFemmesHonneur extends GDatabaseView {
        //===============================================
        ...
        public static function Instance() {
            if(is_null(self::$m_instance)) {
                self::$m_instance = new GDatabaseViewFemmesHonneur();  
            }
        ...
        public function readFile($dataMap, $fileName) {
            ...
            $lAvatarRoot = "/Femmes_Honneur/Membres/img/";
        ...
        public function updateFile($dataMap, $fileName) {
            ...
            $lGroupMap = array("Femme d'Honneur");
