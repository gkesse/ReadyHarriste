<?php   
    class GDatabaseViewJeunesse extends GDatabaseView {
        //===============================================
        ...
        public static function Instance() {
            if(is_null(self::$m_instance)) {
                self::$m_instance = new GDatabaseViewJeunesse();  
            }
        ...
        public function readFile($dataMap, $fileName) {
            ...
            $lAvatarRoot = "/Jeunesse/Membres/img/";
